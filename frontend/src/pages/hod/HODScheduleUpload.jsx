...
const HODScheduleUpload = () => {
    ...
    const downloadTemplate = () => {
        ...
        const sample = "Mid Term Exam,INTERNAL_EXAM,2025-03-15,FN,10:00,13:00,Mathematics,All students must attend";
    ...
    return (
        <div style={{ padding: '24px', maxWidth: '800px', margin: '0 auto' }}>
            ...
            <p>Upload a CSV file containing the schedule for the semester. This will be visible to all students and faculty.</p>

            <div className="glass-card" style={{ padding: '30px', marginTop: '24px' }}>
                <div style={{ marginBottom: '20px' }}>
                    <h3>1. Download Template</h3>
                    <p style={{ fontSize: '0.9rem', color: '#94a3b8' }}>Use this CSV format to prepare your schedule.</p>
                    ...
                    <div style={{ marginTop: '10px', fontSize: '0.8rem', background: 'rgba(0,0,0,0.2)', padding: '10px', borderRadius: '4px' }}>
                        <strong>Allowed Types:</strong> ACADEMIC, LAB_SLOT, SKILL_TRAINING, INTERNAL_EXAM, SEMESTER_EXAM, LAB_PRACTICAL
                    </div>
                </div>
