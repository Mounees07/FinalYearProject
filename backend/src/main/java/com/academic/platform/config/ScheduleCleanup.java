...
public class ScheduleCleanup implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        try {
            ...
            String sql = "DELETE FROM academic_schedules WHERE type IN ('INTERNAL_EXAM', 'SEMESTER_EXAM')";
            int rows = jdbcTemplate.update(sql);
            System.out.println("✅ Deleted " + rows + " existing Exam entries. COE must re-upload official schedules.");
