...
public class LeaveService {
    ...
    public void generateOtpForApproval(Long leaveId, String mentorUid) {
        ...
        if (student.getMentor() == null || !student.getMentor().getFirebaseUid().equals(mentorUid)) {
    ...
    public LeaveRequest getActiveLeaveForStudent(String rollNumber) {
        List<LeaveRequest> leaves = leaveRepository.findByStudentRollNumber(rollNumber);
